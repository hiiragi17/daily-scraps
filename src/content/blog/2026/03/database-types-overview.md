---
title: 'データベースの種類整理とSnowflakeの全体像'
description: 'OLTP/OLAPの違いからSnowflakeのアーキテクチャ、仮想ウェアハウス、タイムトラベルなど独自機能までを整理'
pubDate: 2026-03-07
tags: ['データベース', 'Snowflake', 'OLAP', 'OLTP', 'データウェアハウス']
draft: false
...
- [Snowflake公式ドキュメント - Virtual Warehouses](https://docs.snowflake.com/en/user-guide/warehouses-overview)
...
- [Snowflake公式ドキュメント - Stages](https://docs.snowflake.com/en/user-guide/data-load-overview)
