...
pubDate: 2026-03-11
tags: ['Database', 'MySQL', 'Rails', 'レプリケーション', 'AWS', 'RDS']
draft: false
...
DBへのアクセスは一般的に **「読み取り（SELECT）が8〜9割、書き込みが1〜2割」** という傾向がある。
Read Replica は「読み取りだけ別のサーバーに分散させよう」という発想だ。
...
ActiveRecord::Base.connected_to(role: :reading) do
  ...
  @items = Item.where(category: "example").limit(20)
end
```
